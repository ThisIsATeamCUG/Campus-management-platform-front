...
<!--          </div>-->
          ...
          <div class="single">
            <div class="imgbox">
              <!-- 图片展示 -->
              <img src="https://pic.rmb.bdstatic.com/bjh/news/a13095c2426217452ae29fd70cb470a7.gif" alt="">
            </div>
            <ul>
              <li>
                <!-- 描述 -->
              ...
              <li class="clear">
                <!-- 二手价/原价 -->
                <p class="pricebox">
                  <span class="priTitle">鞋子</span>
                </p>
              </li>
              <li style="padding-left:10px;">
                <span class="price">￥33</span><span>/</span><span class="cost">￥66</span>
              </li>
              <li class="lisc">
								<span class="licount">
									<span>浏览:</span><span>5</span>
									<span>收藏:</span><span>6</span>
                  <img src="@/assets/img/gouwuche.svg" title="收藏">
                </span>
              </li>
              <li class="clear">
                <p>
                  <!-- 时间 -->
                  <span class="item">发布时间 2021-9-22</span>
                  <!-- 收藏次数  浏览次数 点击收藏 -->
                </p>
              </li>
            </ul>
          ...
          <div class="single">
            <div class="imgbox">
              <!-- 图片展示 -->
              <img src="https://pic.rmb.bdstatic.com/bjh/news/150ab5e9263285b9b9f9cae26d7b7797.gif" alt="">
            </div>
            <ul>
              <li>
                <!-- 描述 -->
